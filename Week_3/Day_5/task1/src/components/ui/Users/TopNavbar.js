...
export default function TopNavbar() {
  return (
    <div className="w-full  px-4  flex items-center justify-between border-b border-gray-100">

    
      {/* CENTER: BREADCRUMB */}
      <div className="flex flex-col text-center p-2">
        <p className="text-xs font-bold text-gray-400">
          Pages / <span className="text-gray-600">Tables</span>
        </p>
        <h2 className="flex between text-sm font-semibold text-gray-800">
          Tables
        </h2>
      </div>
